...
augment_args = {
    ...
    "fliplr": 0.75,        # Horizontal flip probability (0-1)
    "mosaic": 0.75,        # Mosaic augmentation probability (0-1)
    "translate": 0.12,     # Translation (fraction of image size, 0-0.2)
...
torch.save(model.model.state_dict(), "run_8.pth")
