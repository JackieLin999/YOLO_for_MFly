...
augment_args = {
    ...
    "degrees": 20,       # Rotation (degrees, 0-45)
    "shear": 0.0,         # Shear (degrees, 0-10)
    "perspective": 0.0,   # Perspective (fraction, 0-0.001)
    "flipud": 0.2,        # Vertical flip probability (0-1)
    "mixup": 0.0,         # MixUp probability (0-1)
    "copy_paste": 0.1,     # Copy-Paste probability (0-1)
}
...
torch.save(model.model.state_dict(), "run_19.pth")
